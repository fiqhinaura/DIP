...
<div class="modal modal-sheet position-static d-block bg-body-secondary p-1 py-md-1" tabindex="-1" role="dialog" id="modalTour">
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      <div class="modal-body p-5">
        <h2 class="fw-bold mb-0">Reservasi Berhasil</h2>
        <?php
                                include 'koneksi.php';
                                $data = mysqli_query($koneksi, "select * from reservasi");
                                while ($x = mysqli_fetch_array($data)) {
                                ?>
        <ul class="d-grid gap-1 my-5 list-unstyled small">
          ...
          <li class="d-flex gap-4">
            ...
            <div>
              ...
              aleenahana@gmail.com
            </div>
          </li>
          <li class="d-flex gap-4">
            <svg class="bi text-primary flex-shrink-0" width="48" height="48"><use xlink:href="#film"/></svg>
            <div>
              <h5 class="mb-0">Tanggal Check-In</h5>
              <?php echo $x['checkin']; ?>
            </div>
          </li>
          <li class="d-flex gap-4">
            <svg class="bi text-primary flex-shrink-0" width="48" height="48"><use xlink:href="#film"/></svg>
            <div>
              <h5 class="mb-0">Tanggal Check-Out</h5>
              <?php echo $x['checkout']; ?>
            </div>
          </li>
          <li class="d-flex gap-4">
